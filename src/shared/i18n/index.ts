...
const en = {
  ...
  "options.autoDownloadSubtitles": "Automatically download caption files after translation",
  "options.autoDownloadSubtitlesHelp": "Downloads the native JSON3 captions fetched by the player and the xTranslator translation result as JSON.",
  ...
  "content.partialTranslationProgress": "{translated}/{total} translated · {missing} remaining. Click to continue.",
  "content.retry": "Retry",
...
const zhCN: Record<keyof typeof en, string> = {
  ...
  "options.autoDownloadSubtitles": "翻译完成后自动下载字幕文件",
  "options.autoDownloadSubtitlesHelp": "同时下载播放器获取的原生 JSON3 字幕和 xTranslator 翻译结果 JSON。",
